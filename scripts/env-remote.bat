...
REM adding bootgen, msys, git, and vim to the path env variable
SET PATH=C:\Xilinx\SDK\%VER%\bin\unwrapped\win64.o;%PATH%
...
REM Remote connections must re-add/re-map network drives for symlinks to work
net use Z: \\TOWER\fishie2610_share